...
-- First, let's ensure canvas_shares emails are only visible to canvas owners (current policy is good)
-- But let's make it more explicit and secure
...
-- Update comments policies to hide author emails from non-owners
...
-- Create new comment policies that protect email privacy
...
-- Allow anonymous comment creation for public canvases
